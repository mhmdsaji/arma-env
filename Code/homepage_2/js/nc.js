  ...
  nc.tabs = function(obj) {
    ...
    if ($(obj.tb).hasClass("tabs-auto")) {
      ...
      if (
        $(obj.tb)
          .find(".tb-list > .tb")
          .hasClass(tb_activeClass)
      ) {
        $(obj.tb)
          .find(".tb-list > .tb.active")
          .click();
      } else {
        $(obj.tb)
          .find(".tb-list > .tb:first")
          .click();
      }
    } else {
      ...
      $(obj)
        .on("click", function(e) {
          ...
          $(obj)
            ...
            .removeClass(tb_activeClass);
          $(this)
            .removeClass(tb_normalClass)
            .addClass(tb_activeClass);
    ...
    enquire
      ...
      .register("(min-width: 200px) and (max-width: 991px)", {
        match: function() {
          ...
          $(".nav-wrp")
            .removeClass("show-above")
            .removeClass("bg-glass");
  ...
  jQuery(document).ready(function($) {
    ...
    if ($o.r) {
      ...
      if ($o.navlink) {
        ...
        $(".nc-navigation--close, .nc-main--pageoverlay").on("click", function(
          event
        ) {
          event.preventDefault();
          toggleNav(false);
        ...
        $("#main-navigation").on("show.bs.collapse", ".collapse", function() {
          $("#main-navigation")
            .find(".collapse.in")
            .collapse("hide");
        });
      ...
      /*----------  PAGE TRANSATION  ----------*/
      if ($o.ncajax) {
        $(".nc-pagelink").on("click", function(e) {
          return;
          var ncPageObj = {
