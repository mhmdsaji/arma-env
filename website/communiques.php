...
<head>
    <?php $pageName = "Communiqués | ARMA Environnement" ?>
                        ...
                        <div class="col-md-9 offset-md-1">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Communiqués</li>
                                </ol>
                            </nav>
                            <h1 class="page-title">Nos communiqués de presse</h1>
                                ...
                                <div class="card-deck mb-4">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <a href="#" class="btn blue-btn small"><i class="fas fa-file-pdf"></i> Télécharger</a>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-body">
