				...
				<div class="content-area">
					...
					<div class="page row no-gutters">
						<div class="col-lg-9 offset-lg-1">
							...
							<div class="page-banner" style="background-image: url(assets/img/content/projets/casablanca.jpg);">
							...
							<div class="row">
								...
								<aside class="col-lg-4">
									...
									<div class="arma-stats large blue">
										<div class="arma-stats-inner"><span class="bold">+<span class="number-scroll">3000</span></span>
