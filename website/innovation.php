		...
		<div class="row no-gutters">
			...
			<div id="page-wrapper" class="innov-page">				
				<div class="content-area">
					...
					<section id="staff" class="section white-text full-bg after mystaff" style="background-image: url(assets/img/innovation.png)">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7">
                                    <h2 class="section-title wow animated zoomIn" data-wow-delay=".2s">NOS INNOVATIONS</h2>
                                    <h3 class="section-subtitle wow animated zoomIn" data-wow-delay=".4s"><img class="innov-logo" src="assets/img/icons/mystaff.png" alt="MyStaff" height="50"></h3>
                    ...
                    <section id="ask" class="section white-text full-bg after ask" style="background-image: url(assets/img/innovation.png)">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7">
                                    <h2 class="section-title wow animated zoomIn" data-wow-delay=".2s">NOS INNOVATIONS</h2>
                                    <h3 class="section-subtitle wow animated zoomIn" data-wow-delay=".4s"><img class="innov-logo" src="assets/img/icons/ask-logo.png" alt="Ask" height="50"></h3>
                    ...
                    <section id="clean" class="section white-text full-bg after ask" style="background-image: url(assets/img/innovation.png)">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7">
                                    <h2 class="section-title wow animated zoomIn" data-wow-delay=".2s">NOS INNOVATIONS</h2>
                                    <h3 class="section-subtitle wow animated zoomIn" data-wow-delay=".4s"><img class="innov-logo" src="assets/img/icons/cleanplus-logo.png" alt="CLEAN+" height="50"></h3>
