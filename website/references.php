						...
						<div class="page row no-gutters">
							<div class="col-md-9 offset-md-1">
                                ...
                                <div class="text-bloc content-wrapper no-bg col-md-10 sub-h1">
									<p>ARMA Environnement est en mesure d’intervenir sur l’ensemble du territoire marocain grâce à un large réseau qui couvre actuellement 16 villes. Avec une force de frappe de plus 6 500 collaborateurs, vous pourrez compter sur notre réactivité et notre efficacité.</p>
								</div>
                                <div class="row content-bloc wow fadeIn references white-bg">
                                    <img class="m-4" src="assets/img/small-logos/references.png" alt="references">
                                    <img class="m-4" src="assets/img/small-logos/references2.png" alt="references">
                                </div>
							</div>
						</div>
					</div>
