								...
								<div class="col-md-10 offset-md-1  wow animated fadeIn" data-wow-delay=".6s">
										...
										<div class="col-sm-7">
											<div class="arma-stats-group">
												...
												<div class="arma-stats small blue">
													<div class="arma-stats-inner">
														<span class="bold number-scroll">27</span>
														<br/>Villes
													</div>
												</div>
											</div>
									...
									<div class="row content-bloc">
										...
										<div class="col-sm-5">
											...
											<div class="arma-stats large red">
												<div class="arma-stats-inner"><span class="bold">3</span><span class="light">millions</span>
									...
									<div class="row content-bloc">
										<div class="col-sm-7">
											<div class="arma-stats-group mb-4">
												<div class="arma-stats small blue">
													<div class="arma-stats-inner">
														<span class="bold number-scroll">46</span>
														<br />Clients
													</div>
												</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="title-text pr-md-4 mb-md-5">
										<h4>DES VILLES PLUS PROPRES</h4>
										<p class="small">Défi majeur pour nos villes, la propreté urbaine ne peut être confiée qu’à un spécialiste. ARMA Environnement s’engage sur une prestation de haute qualité afin de permettre aux habitants d’évoluer dans un cadre de vie sain et de profiter des différents espaces de la ville.</p>
									</div>
									<div class="title-text pr-md-4 mb-md-5">
								...
								<div class="col-md-4">
									<div class="title-text pr-md-4 mb-md-5">
										<h4>DES VILLES PLUS ÉCLAIRÉE</h4>
										<p class="small">Facteur clé d’attractivité des villes, l’éclairage public participe à mettre en valeur les espaces de vie et à générer un sentiment de sécurité pour les citoyens. ARMA Environnement intervient auprès des villes à travers des solutions d’éclairage intelligent, permettant de mettre en place un éclairage attrayant et durable, et à maitriser les dépenses énergétiques.</p>
									</div>
									<div class="title-text pr-md-4 mb-md-5">
										<h4>DES VILLES PLUS VERTES ET MIEUX AMÉNAGÉES</h4>
										<p class="small">Véritables poumons au sein des villes, les espaces verts et leurs aménagements doivent être valorisés et entretenus pour le bien-être des habitants. ARMA Environnement offre une palette de services permettant d’entretenir, d’embellir et de prendre soin des espaces de respiration.</p>
									</div>
								</div>
							</div>
						</div>
					...
					<section id="refs" class="section bg-blue white-text full">
						<div class="container">
							<div class="row">
								...
								<div class="col-md-7">
									<div class="img-container" style="background-image: url(assets/img/refs.png)">
										<img src="assets/img/refs.png" alt="NOS REFERENCES">
									</div>
								</div>
							</div>
						</div>
